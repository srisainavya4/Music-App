...
//class MySecondAdapter(private val songlist: ArrayList<MyLatest>) : RecyclerView.Adapter<MySecondAdapter.MyViewHolder>() {
//
...
//            intent.putExtra("titleImage", byteArray)
    ...
    class MyViewHolder(itemView: View, private val songlist: ArrayList<MyLatest>) : RecyclerView.ViewHolder(itemView){
